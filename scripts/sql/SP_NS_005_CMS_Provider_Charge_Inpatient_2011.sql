USE [NS_Import]
GO
/****** Object:  StoredProcedure [dbo].[SP_NS_005_CMS_Provider_Charge_Inpatient_2011]    Script Date: 7/23/2015 3:34:16 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SP_NS_005_CMS_Provider_Charge_Inpatient_2011]
AS
BEGIN
	...
	SELECT
		...
		'Medicare_Provider_Charge_Inpatient_DRG100_FY2011.csv' source_file_name,
		'CMS' source_type

	FROM 
		[dbo].[Medicare_Provider_Charge_Inpatient_DRG100_FY2011]  i
