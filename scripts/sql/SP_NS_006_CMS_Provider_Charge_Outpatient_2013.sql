USE [NS_Import]
GO
/****** Object:  StoredProcedure [dbo].[SP_NS_006_CMS_Provider_Charge_Outpatient_2013]    Script Date: 7/23/2015 3:34:16 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SP_NS_006_CMS_Provider_Charge_Outpatient_2013]
AS
BEGIN
	...
	SELECT
		...
		'Medicare_Provider_Charge_Outpatient_APC30_CY2013.csv' source_file_name,
		'CMS' source_type

	FROM 
		[dbo].[Medicare_Provider_Charge_Outpatient_APC30_CY2013]  i
