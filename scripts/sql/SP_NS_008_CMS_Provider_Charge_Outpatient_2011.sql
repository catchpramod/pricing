USE [NS_Import]
GO
/****** Object:  StoredProcedure [dbo].[SP_NS_008_CMS_Provider_Charge_Outpatient_2011]    Script Date: 7/23/2015 3:34:16 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SP_NS_008_CMS_Provider_Charge_Outpatient_2011]
AS
BEGIN
	...
	SELECT
		...
		cast('2011-06-30' as Date) service_date,
		i.[Average Total Payments],
		i.[Average  Estimated Submitted Charges],
		cast(GETDATE() as date) import_date,
		'Medicare_Provider_Charge_Outpatient_APC30_CY2011.csv' source_file_name,
		'CMS' source_type

	FROM 
		[dbo].[Medicare_Provider_Charge_Outpatient_APC30_CY2011]  i
